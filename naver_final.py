...
samsung_laptop_questions = [
    "갤럭시탭 최신 모델 추천해주세요.",
    "갤럭시탭 아이패드 시리즈 비교해주세요.",
    "갤럭시탭 가성비 좋은 모델은 무엇인가요?"
]
default_queries_map = {
...
# 검색 입력 필드 도움말 텍스트
help_texts = {
    "쇼핑": "갤럭시탭 추천 질문을 클릭하거나 직접 검색어를 입력하세요.",
    "블로그": "블로그 관련 검색어를 입력하세요. (예: 가성비 태블릿)",
    "뉴스": "뉴스 관련 검색어를 입력하세요. (예: 최신 전자기기 시장 동향)"
}
...
# "쇼핑" 탭일 때 갤럭시탭 추천 질문 버튼 표시
if active_source_type == "쇼핑":
    st.markdown("👇 **갤럭시탭 관련 추천 질문을 선택해보세요!**")
...
- 쇼핑: 상품 정보, 가격 비교, 구매 팁 등 (예: 갤럭시탭 추천)
